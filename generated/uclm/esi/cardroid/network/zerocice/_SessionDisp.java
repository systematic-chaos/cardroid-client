...
public abstract class _SessionDisp extends Ice.ObjectImpl implements Session
{
    ...
    public static Ice.DispatchStatus ___getCardroidManager(Session __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    public static Ice.DispatchStatus ___getTopic(Session __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.readEmptyParams();
    ...
    public static Ice.DispatchStatus ___refresh(Session __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    public static Ice.DispatchStatus ___destroy(Session __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.readEmptyParams();
