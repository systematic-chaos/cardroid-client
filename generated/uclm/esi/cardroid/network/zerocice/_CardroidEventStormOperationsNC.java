 ...
 * 
 **/
public interface _CardroidEventStormOperationsNC
{
    /**
     * This message arrives due the occurrence of an user-related action
     * 
     **/
    void _notify(uclm.esi.cardroid.data.zerocice.UserActivityTypPrx action);
     ...
     * 
     **/
    void message(uclm.esi.cardroid.data.zerocice.MessageTypPrx msg);
}
