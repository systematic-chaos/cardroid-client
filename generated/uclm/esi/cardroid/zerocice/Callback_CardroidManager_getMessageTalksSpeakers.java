...
public abstract class Callback_CardroidManager_getMessageTalksSpeakers extends Ice.TwowayCallback
{
    ...
    public final void __completed(Ice.AsyncResult __result)
    {
        ...
        try
        {
            __proxy.end_getMessageTalksSpeakers(first, nrows, result, __result);
        }
