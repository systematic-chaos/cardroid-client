...
public final class TripTypPrxHelper extends Ice.ObjectPrxHelperBase implements TripTypPrx
{
        ...
        try
        {
            while(true)
            {
                ...
                try
                {
                    ...
                    _TripTypDel __del = (_TripTypDel)__delBase;
    ...
    public static TripTypPrx checkedCast(Ice.ObjectPrx __obj)
    {
        TripTypPrx __d = null;
        if(__obj != null)
        {
            if(__obj instanceof TripTypPrx)
            {
                __d = (TripTypPrx)__obj;
            }
            else
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    TripTypPrxHelper __h = new TripTypPrxHelper();
    ...
    public static TripTypPrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        TripTypPrx __d = null;
        if(__obj != null)
        {
    ...
    public static TripTypPrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        TripTypPrx __d = null;
        if(__obj != null)
        {
    ...
    public static TripTypPrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        TripTypPrx __d = null;
        if(__obj != null)
        {
    ...
    public static TripTypPrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        TripTypPrx __d = null;
        if(__obj != null)
        {
    ...
    public static TripTypPrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        TripTypPrx __d = null;
        if(__obj != null)
        {
    ...
    {
        return new _TripTypDelM();
    }

    protected Ice._ObjectDelD __createDelegateD()
    {
        return new _TripTypDelD();
    }

    public static void __write(IceInternal.BasicStream __os, TripTypPrx v)
    {
        __os.writeProxy(v);
    }

    public static TripTypPrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            TripTypPrxHelper result = new TripTypPrxHelper();
